...
su - crc -c 'test -f ~crc/.crc/cache/crc_*crcbundle || ln -s /mnt/volume/crc_libvirt_4.6.3.crcbundle  ~crc/.crc/cache/crc_libvirt_4.6.3.crcbundle'
su - crc -c 'crc setup'
...
# echo 'Now run as user <crc>:    crc start --disk-size 70 --nameserver 67.207.67.3  --bundle /mnt/volume/crc_libvirt_4.6.3.crcbundle'
echo 'Now run as user <crc>:    crc start --disk-size 70 --bundle /mnt/volume/crc_libvirt_4.6.3.crcbundle'
