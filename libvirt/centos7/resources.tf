...
resource "libvirt_volume" "CentOS7-cloud-image" {
  ...
  source = "/download/CentOS-7-x86_64-GenericCloud-20150628_01.qcow2"
...
resource "libvirt_volume" "rootvol" {
  ...
  format = "qcow2"
  base_volume_id = libvirt_volume.CentOS7-cloud-image.id
}
